...
<div class="p-6 animate-fadeIn">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm mb-6 print:hidden">
        <form action="<?= current_url() ?>" method="GET" class="flex flex-col md:flex-row items-end gap-4">
            ...
            <a href="<?= current_url() ?>" class="w-full md:w-auto px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-xl transition-colors text-center">
                Reset
            </a>
        </form>
    </div>
